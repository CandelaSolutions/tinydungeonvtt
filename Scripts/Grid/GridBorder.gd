...
func generate_pillars(sides: int = 6, radius: float = 0.05, rotation: float = 0) -> void:
	var points = get_parent().points
	generate_pillar(Vector3(points[0].x, -1, points[0].z), Vector3(points[0].x, 1, points[0].z), sides, radius, rotation)
	#generate_pillar(Vector3(points[1].x, -1, points[1].z), Vector3(points[1].x, 1, points[1].z), sides, radius, rotation)
	#generate_pillar(Vector3(points[2].x, -1, points[2].z), Vector3(points[2].x, 1, points[2].z), sides, radius, rotation)
	#generate_pillar(Vector3(points[3].x, -1, points[3].z), Vector3(points[3].x, 1, points[3].z), sides, radius, rotation)
	#generate_pillar(Vector3(points[4].x, -1, points[4].z), Vector3(points[4].x, 1, points[4].z), sides, radius, rotation)
	#generate_pillar(Vector3(points[5].x, -1, points[5].z), Vector3(points[5].x, 1, points[5].z), sides, radius, rotation)
